...
<body>
    ...
    <div class="container my-5 ">
        ...
        <div class="col-8 mx-auto rounded shadow-lg p-4" style="background-color: #0d75bc;">
          ...
          <h2 class="text-white text-center py-3">Forget Password</h2>
          <p class="text-white text-center">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one</p>
          ...
          <button class="btn btn-light mt-3 fs-3 w-100 py-2 " style="color: #0d75bc">Send</button>
