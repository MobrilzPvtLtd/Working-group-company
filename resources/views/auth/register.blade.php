...
<body>
    <div class="container my-5 ">
        ...
        <div class="col-8 mx-auto rounded shadow-lg p-4" style="background-color: #0d75bc;">
          ...
          <h2 class="text-white text-center py-3">formulaire d'inscription</h2>
          ...
          <input type="text" class="form-control mb-2 py-3 border-0" placeholder="Nām" style="background-color: #4697ce" />
          <input type="text" class="form-control  mb-2 py-3 border-0" placeholder="ˈēˌmāl" style="background-color: #4697ce"  />
          <input type="text" class="form-control mb-2 py-3 border-0" placeholder="mot de passe" style="background-color: #4697ce" />
          <input type="text" class="form-control  mb-2 py-3 border-0" placeholder="Confirmez le mot de passe" style="background-color: #4697ce"  />


          <button class="btn btn-light mt-3 fs-3 w-100 py-2 " style="color: #0d75bc">Registre</button>


          </form>  </div>
          <div class="text-center text-white py-4">
            <p>Already an account ? <a href="/login" class="text-white">Se connecter</a>  </p>
