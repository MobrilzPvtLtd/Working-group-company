        ...
        <ul class="header-nav d-none d-lg-flex">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('frontend.index') }}" target="_blank">
                    Working Group &nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button"
                    ...
                    {{-- <div class="avatar avatar-md"> --}}
                        ...
                        @else
                            <!-- Optionally, provide a default avatar or an alternative fallback image -->
                            <div class="avatar avatar-md">
                                <img class="avatar-img" src="{{ asset('path/to/default-avatar.jpg') }}"
                                    alt="Default Avatar">
                            </div>
                        @endif
