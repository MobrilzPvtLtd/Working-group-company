    ...
    {{-- <section class="tw-py-12 tw-bg-gray-100" data-testid="landing-header-container">
        <div class="tw-container tw-m-auto container">
            <div class="md:tw-grid md:tw-gap-2 md:tw-grid-cols-2">
                <div>
                    <h1 class="tw-mb-3 tw-mt-0 tw-text-4xl md:tw-text-5xl tw-text-dark-blue-500" style="font-size: 64px">
                    ...
                    <div class="tw-py-6" data-testid="category-search">
                        <div class="tw-flex tw-gap-2">
                                ...
                                <div class="bark-autocomplete_input__oqc2S">
                                    <div class="Input_inputIconWrapperBase__WhfG2">
                                        <div class="Input_inputWrapperBase__gttO8" style="color: #000">
                                            <input name="autocomplete" id="signup-choose-category" aria-label="autocomplete"
                                                type="text" class="Input_inputBase__duizE Input_inputWithoutIcon__6Rf68"
                                                autocomplete="off" role="combobox" style="color: #000"
                                                placeholder="{{ __('What service do you provide?') }}"
                                                data-cy="seller-signup-splash-category-search" value="" />
                            ...
                            <button onclick="document.location='{{ route('form2') }}'"
                                ...
                                <span class="tw-flex tw-justify-center"><span class="button-main"><span
                                            class="child-container Button_childContainer__YG7FP">{{ __('Get started') }}</span></span></span>
                            </button>
                        </div>
                    </div>
                    <div data-testid="popular-services-list">
                        ...
                        <div class="PopularServices_popularServicesBlock__sMKIy">
                            <div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg" class="tw-inline-block">
                                                ...
                                                class="tw-truncate label-text">{{ __('House Cleaning') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Life Coaching') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Web Design') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('General Photography') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Web Development') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Social Media Marketing') }}</span></span></a>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Graphic Design') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Bookkeeping Services') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Building Contractors') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Personal Trainers') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                ...
                                                class="tw-truncate label-text">{{ __('Gardening') }}</span></span></a>
                                </div>
                                <div>
                                    <a href="{{ route('form2') }}" class="PopularServices_itemLink__FhD1M item-link"
                                        data-cy="seller-signup-splash-popular-service"><span
                                            class="PopularServices_itemLabelText__L7nmu"><span class="tw-pr-2"><svg
                                                    ...
                                                    xmlns="http://www.w3.org/2000/svg" class="tw-inline-block">
                                                    <rect width="24" height="24"></rect>
                                                    <path d="M8.17 5.7L1 10.48V21H6V13H10V21H15V10.25L8.17 5.7Z"
                                                        fill="currentColor"></path>
                                                    <path
                                                        d="M10 3V4.51L12 5.84L13.73 7H15V7.85L17 9.19V11H19V13H17V15H19V17H17V21H23V3H10ZM19 9H17V7H19V9Z"
                                                        fill="currentColor"></path>
                                                </svg></span><span
                                                class="tw-truncate label-text">{{ __('Commercial & Office Cleaning') }}</span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tw-hidden md:tw-flex tw-items-center">
                    <div class="tw-max-w-[70%] tw-ml-auto">
                        <div class="tw-relative" data-testid="rated-excellent-trustpilot"
                            data-cy="seller-signup-splash-rated-excellent">
                            <img src="assets/img/hero/a-dog-walk-walking-the-dogs-in-the-city-2022-11-08-10-52-58-utc.jpg"
                                class="tw-relative tw-left-0 tw-top-0 tw-w-full tw-object-cover" alt="Splash" />
                            <!-- <svg
