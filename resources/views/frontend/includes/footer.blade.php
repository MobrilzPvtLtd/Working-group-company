...
<footer>
    ...
    <div class="container-fluid position-relative img_footer d-none d-sm-none d-md-block">

        <div class="row">

            <div class="text-start"> <img src="./public/assets/img/bg/advantage_logo.png" alt="WGC Logo"
                    class="rounded pt-3 px-5"> </div>
        ...
        <div class="row mx-auto">
            ...
            <div class="col-md-3 pt-5 col-6">
                ...
                <ul class="text-white pt-2">
                    ...
                    <li><a class="text-white" href="/about">À propos</a></li>

                    <li><a class="text-white" href="/service">Services</a></li>
                    <li><a class="text-white" href="/contact">Contactez-nous</a></li>
                </ul>
            </div>
            <div class="col-md-3 pt-5 col-6">
                <h3 class="text-white">Notre bureau</h3>
    ...
    <div class="container-fluid bg-white d-block d-md-none">
        ...
        <div class="d-flex justify-content-between mb-3 align-items-center">
            ...
            <div class="text-end"><a href=""> <img src=".\public\img\chat_logo.png" alt="chat"
                        width="10%"> </a> </div>
        </div>
